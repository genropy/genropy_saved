...
class GnrCustomWebPage(object):
    def main(self, root, **kwargs):
        ...
        top = layout.contentPane(layoutAlign='top').div('Genro Dojo - Examples & Tutorial', _class='demotitle')
        ...
        tree = left.tree(storepath='tree',label="Examples",inspect='shift',selected_rel_path='selected.demopath')
