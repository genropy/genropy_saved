...
class GnrCustomWebPage(object):
    ...
    def rpc_thermoProgress(self, thermoid, stop=None):
        try:
            ...
            thermoBag = self.session.pagedata.getItem('thermo_%s' % thermoid) or Bag()
            ...
            if stop: 
                ...
                self.session.pagedata.setItem('thermo_%s' % thermoid, thermoBag)
    ...
    def setThermo(self, thermoid, progress_1=None, message_1=None, maximum_1=None, indeterminate_1=None, stop=None, end=None, **kwargs):
        ...
        #self.gnotify('thermoBag', thermoBag.asString(), always=True)
        ...
        #thermoBag.toXml(self.pageLocalDocument(), autocreate=True)
