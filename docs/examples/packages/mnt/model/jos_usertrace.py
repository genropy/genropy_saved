...
class Table(object):
    def config_db(self, pkg):
        tbl =  pkg.table('jos_usertrace',  pkey='id',name_long='jos_usertrace',rowcaption='$username')
        tbl.column('id', dtype ='L', name_long ='!!Id', notnull ='y')  
        tbl.column('username', size ='0:25', dtype ='A', name_long ='!!Username', notnull ='y').relation('jos_users.username',many_name='Accessi IP',one_name='Utente')
