...
============
    ...
    The Genro :ref:`bag` has a consistent number of methods. They are listed here in alphabetical order.
...
================
    ...
    The Genro :ref:`bagnode` has a relevant number of methods. They are listed here in alphabetical order.
