...
var ns=_1b.style;
if(!ns.zoom.length&&d.style(_1b,"zoom")=="normal"){
ns.zoom="1";
}
...
d.connect(_2e,"onAnimate",_2e,function(_36){
for(var s in _36){
d.style(this.node,s,_36[s]);
}
});
return _2e;
};
dojo.anim=function(_38,_39,_3a,_3b,_3c,_3d){
return d.animateProperty({node:_38,duration:_3a||d._Animation.prototype.duration,properties:_39,easing:_3b,onEnd:_3c}).play(_3d||0);
};
})();
}
