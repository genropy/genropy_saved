...
var _6d=this._pending._newItems[_6c];
_6d[this._storeRefPropName]=null;
this._arrayOfAllItems[_6d[this._itemNumPropName]]=null;
if(_6d[this._rootItemPropName]){
this._removeArrayElement(this._arrayOfTopLevelItems,_6d);
}
if(this._itemsByIdentity){
...
var _6e=this._pending._modifiedItems[_6c];
var _6f=null;
if(this._itemsByIdentity){
_6f=this._itemsByIdentity[_6c];
}else{
_6f=this._arrayOfAllItems[_6c];
}
...
if(this._itemsByIdentity){
this._itemsByIdentity[_6c]=_6e;
}
}
var _73;
for(_6c in this._pending._deletedItems){
_73=this._pending._deletedItems[_6c];
...
return new Boolean(this._pending._newItems[_78]||this._pending._modifiedItems[_78]||this._pending._deletedItems[_78]);
}else{
