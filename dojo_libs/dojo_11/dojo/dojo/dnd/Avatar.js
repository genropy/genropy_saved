...
var _7=this.manager.source;
for(var i=0;i<k;++i){
tr=dojo.doc.createElement("tr");
tr.className="dojoDndAvatarItem";
td=dojo.doc.createElement("td");
if(_7.creator){
node=_7._normalizedCreator(_7.getItem(this.manager.nodes[i].id).data,"avatar").node;
}else{
node=this.manager.nodes[i].cloneNode(true);
if(node.tagName.toLowerCase()=="tr"){
var _9=dojo.doc.createElement("table"),_a=dojo.doc.createElement("tbody");
_a.appendChild(node);
_9.appendChild(_a);
node=_9;
}
...
dojo.query("tr.dojoDndAvatarHeader td").forEach(function(_b){
