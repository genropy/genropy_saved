...
},_calc:function(_6,_7){
if(this._hAxis){
if(!this._hAxis.initialized()){
this._hAxis.calculate(_7.hmin,_7.hmax,_6.width);
}
this._hScaler=this._hAxis.getScaler();
}else{
this._hScaler={bounds:{lower:_7.hmin,upper:_7.hmax},scale:_6.width/(_7.hmax-_7.hmin)};
}
if(this._vAxis){
if(!this._vAxis.initialized()){
this._vAxis.calculate(_7.vmin,_7.vmax,_6.height);
}
this._vScaler=this._vAxis.getScaler();
}else{
this._vScaler={bounds:{lower:_7.vmin,upper:_7.vmax},scale:_6.height/(_7.vmax-_7.vmin)};
}
}});
}
