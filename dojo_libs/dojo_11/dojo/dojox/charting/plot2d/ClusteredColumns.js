...
var t=this.chart.theme,_9,_a,_b,f,_d=this.opt.gap<this._hScaler.scale/3?this.opt.gap:0,_e=(this._hScaler.scale-2*_d)/this.series.length;
...
var _11=Math.max(0,this._vScaler.bounds.lower),_12=_5.l+this._hScaler.scale*(0.5-this._hScaler.bounds.lower)+_d+_e*i,_13=_4.height-_5.b-this._vScaler.scale*(_11-this._vScaler.bounds.lower);
for(var j=0;j<run.data.length;++j){
var v=run.data[j],_16=_e,_17=this._vScaler.scale*(v-_11),h=Math.abs(_17);
if(_16>=1&&h>=1){
var _19=s.createRect({x:_12+this._hScaler.scale*j,y:_13-(_17<0?0:_17),width:_16,height:h}).setFill(_b).setStroke(_a);
