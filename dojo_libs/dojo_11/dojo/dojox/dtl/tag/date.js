...
dojox.dtl.tag.date.now=function(_5,_6){
var _7=_6.split((_6.substring(0,5)=="now '")?"'":"\"");
if(_7.length!=3){
throw new Error("'now' statement takes one argument");
}
var _8=_7[1];
return new dojox.dtl.tag.date.NowNode(_8,_5.getTextNodeConstructor());
};
}
