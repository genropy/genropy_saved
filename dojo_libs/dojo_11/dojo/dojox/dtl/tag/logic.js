...
if(this.falses){
_1a=this.falses.unrender(_19,_1a);
}
return (this.trues)?this.trues.render(_19,_1a,this):_1a;
}
if(this.trues){
_1a=this.trues.unrender(_19,_1a);
}
...
return new this.constructor(this.var1.getExpression(),this.var2.getExpression(),this.trues.clone(_1f),this.falses.clone(_1f),this.negate);
}});
_3.ForNode=dojo.extend(function(_20,_21,_22,_23){
this.assign=_20;
...
var _29=false;
var _2a=this.assign;
for(k=0;k<_2a.length;k++){
if(typeof _24[_2a[k]]!="undefined"){
_29=true;
_24.push();
break;
}
}
var _2b=this.loop.resolve(_24)||[];
for(i=_2b.length;i<this.pool.length;i++){
this.pool[i].unrender(_24,_25);
}
if(this.reversed){
_2b=_2b.slice(0).reverse();
}
var _2c=dojo.isObject(_2b)&&!dojo.isArrayLike(_2b);
var _2d=[];
if(_2c){
for(var key in _2b){
_2d.push(_2b[key]);
...
var _2f=_24.forloop={parentloop:_24.forloop||{}};
var j=0;
for(i=0;i<_2d.length;i++){
var _30=_2d[i];
_2f.counter0=j;
_2f.counter=j+1;
_2f.revcounter0=_2d.length-j-1;
_2f.revcounter=_2d.length-j;
_2f.first=!j;
_2f.last=(j==_2d.length-1);
if(_2a.length>1&&dojo.isArrayLike(_30)){
if(!_29){
_29=true;
_24.push();
}
var _31={};
for(k=0;k<_30.length&&k<_2a.length;k++){
_31[_2a[k]]=_30[k];
}
_24.update(_31);
}else{
...
for(var i=0,_35;_35=this.pool[i];i++){
_33=_35.unrender(_32,_33);
}
return _33;
},clone:function(_36){
return new this.constructor(this.assign,this.loop.getExpression(),this.reversed,this.nodelist.clone(_36));
}});
dojo.mixin(_3,{if_:function(_37,_38){
var i,_3a,_3b,_3c=[],_3d=_2.pySplit(_38);
_3d.shift();
_38=_3d.join(" ");
_3d=_38.split(" and ");
if(_3d.length==1){
...
for(i=0;_3a=_3d[i];i++){
var not=false;
if(_3a.indexOf("not ")==0){
_3a=_3a.slice(4);
not=true;
}
_3c.push([not,new dd._Filter(_3a)]);
}
var _3f=_37.parse(["else","endif"]);
var _40=false;
var _41=_37.next();
if(_41.text=="else"){
_40=_37.parse(["endif"]);
...
return new _3.IfNode(_3c,_3f,_40,_3b);
},_ifequal:function(_42,_43,_44){
var _45=_2.pySplit(_43);
if(_45.length!=3){
throw new Error(_45[0]+" takes two arguments");
}
var end="end"+_45[0];
var _47=_42.parse(["else",end]);
var _48=false;
var _49=_42.next();
if(_49.text=="else"){
_48=_42.parse([end]);
...
return new _3.IfEqualNode(_45[1],_45[2],_47,_48,_44);
...
var _50=_2.pySplit(_4f);
if(_50.length<4){
throw new Error("'for' statements should have at least four words: "+_4f);
}
var _51=_50[_50.length-1]=="reversed";
var _52=(_51)?-3:-2;
if(_50[_50.length+_52]!="in"){
throw new Error("'for' tag received an invalid argument: "+_4f);
}
