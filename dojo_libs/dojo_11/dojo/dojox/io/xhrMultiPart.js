...
function _needIframe(_5){
return (!!(dojo.query("input[type=file]",_5).length));
};
function _partsFromNode(_6,_7){
var _8=[];
return _8;
};
dojox.io.xhrMultiPart=function(_9){
if(!_9["file"]&&!_9["form"]){
throw new Error("file or form must be provided to dojox.io.xhrMultiPart's arguments");
}
var _a=dojox.uuid.generateRandomUuid();
var _b=[];
var _c="";
if(_9["file"]){
var d=(dojo.isArray(_9.file)?_9.file:[_9.file]);
for(var i=0;i<d.length;i++){
_b=_b.concat(_createPart(d[i],_a));
}
}
if(_9["form"]){
_b=_b.concat(_partsFromNode(_9["form"],_a));
}
if(_b.length){
_b.push("--"+_a+"--","");
_c=_b.join("\r\n");
