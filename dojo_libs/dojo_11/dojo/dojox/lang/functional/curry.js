...
return _2({func:_3.func,arity:_3.arity,args:Array.prototype.concat.apply(_3.args,arguments)});
}
return _3.func.apply(this,Array.prototype.concat.apply(_3.args,arguments));
};
};
dojo.mixin(df,{curry:function(f,_5){
f=df.lambda(f);
_5=typeof _5=="number"?_5:f.length;
return _2({func:f,arity:_5,args:[]});
},arg:{},partial:function(f){
var a=arguments,_8=new Array(a.length-1),p=[];
f=df.lambda(f);
...
return function(){
var t=Array.prototype.slice.call(_8,0);
