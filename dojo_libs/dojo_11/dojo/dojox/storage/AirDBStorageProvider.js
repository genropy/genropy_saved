...
this._sql("DELETE FROM "+this.TABLE_NAME+" WHERE namespace = :namespace AND key = :key",{":namespace":_1a,":key":key[i]});
this._sql("INSERT INTO "+this.TABLE_NAME+" VALUES (:namespace, :key, :value)",{":namespace":_1a,":key":key[i],":value":value});
}
...
if(_19){
_19(this.FAILED,_17,e.toString());
}
return;
}
if(_19){
_19(this.SUCCESS,key,null);
}
