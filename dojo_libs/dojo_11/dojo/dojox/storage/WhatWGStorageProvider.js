...
try{
var _1=globalStorage[((location.hostname=="localhost")?"localhost.localdomain":location.hostname)];
}
catch(e){
...
this._statusHandler.call(null,this.FAILED,_2,e.toString());
}
},get:function(_9,_a){
