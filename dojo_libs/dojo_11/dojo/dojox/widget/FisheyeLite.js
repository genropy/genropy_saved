...
dojo.declare("dojox.widget.FisheyeLite",dijit._Widget,{durationIn:350,easeIn:dojox.fx.easing.backOut,durationOut:1420,easeOut:dojox.fx.easing.elasticOut,properties:{fontSize:2.75},unit:"px",postCreate:function(){
...
var v=parseInt(cs[p]);
_2[p]={end:v,unit:this.unit};
_1[p]={end:(this.properties[p]*v),unit:this.unit};
}
this._runningIn=dojo.animateProperty({node:this._target,easing:this.easeIn,duration:this.durationIn,properties:_1});
this._runningOut=dojo.animateProperty({node:this._target,duration:this.durationOut,easing:this.easeOut,properties:_2});
