...
_GNRINSTANCES=(os.environ.get('GNRINSTANCES') and os.path.split(os.environ.get('GNRINSTANCES'))) or (_GNRHOME+('data','instances'))
GNRINSTANCES=os.path.join(*_GNRINSTANCES)
_GNRPACKAGES=(os.environ.get('GNRPACKAGES') and os.path.split(os.environ.get('GNRPACKAGES'))) or (_GNRHOME+('packages',))
