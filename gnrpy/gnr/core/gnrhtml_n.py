...
class GnrHtmlSrc(GnrStructData):
    ...
    html_autocontent_NS=['style','div','h1', 'h2', 'h3','h4','h5', 'h6','span','td','li','b','i','small', 'strong','p','pre', 'q',]
    ...
    def row_(self, height=0, row_border=None, cell_border=None,lbl_height=None, lbl_class=None,content_class=None, **kwargs):
    ...
    def cell_(self, content=None,width=0, content_class=None, lbl=None,lbl_class=None,lbl_height=None, cell_border=None, **kwargs):
...
class GnrHtmlBuilder(object):
    ...
    def toHtml(self,filename=None):
        ...
        self.compile()
        return self.compiled.toXml(filename=filename,omitRoot=True,autocreate=True,addBagTypeAttr=False, typeattrs=False)
    ...
    def compile_layout(self,parent, layout, attr):
        ...
        layout= AuxObject(attr,('top','left','bottom','right','width','height','border_width','lbl_height'),
                     ('um','border_color','border_style','row_border','cell_border','lbl_class','content_class'))
