...
class GnrRmlSrc(GnrStructData):
    ...
    def document(self, filename=None, debug=None, compression=None, invariant=None, **kwargs):
        return self.child('document', filename=filename, debug=debug, compression=compression, invariant=invariant, **kwargs)
    ...
    def paraStyle(self, fontName=None, fontSize=None, leading=None, leftIndent=None, rightIndent=None, firstLineIndent=None, spaceBefore=None, spaceAfter=None, alignment=None, bulletFontName=None, bulletFontSize=None, bulletIndent=None, textColor=None, backColor=None, keepWithNext=None, wordWrap=None, name=None, alias=None, parent=None, **kwargs):
        return self.child('paraStyle', fontName=fontName, fontSize=fontSize, leading=leading, leftIndent=leftIndent, rightIndent=rightIndent, firstLineIndent=firstLineIndent, spaceBefore=spaceBefore, spaceAfter=spaceAfter, alignment=alignment, bulletFontName=bulletFontName, bulletFontSize=bulletFontSize, bulletIndent=bulletIndent, textColor=textColor, backColor=backColor, keepWithNext=keepWithNext, wordWrap=wordWrap, name=name, alias=alias, parent=parent, **kwargs)
    ...
    def blockBackground(self, start=None, stop=None, colorName=None, colorsByRow=None, colorsByCol=None, **kwargs):
        return self.child('blockBackground', start=start, stop=stop, colorName=colorName, colorsByRow=colorsByRow, colorsByCol=colorsByCol, **kwargs)
    ...
    def template(self, pagesize=None, rotation=None, leftMargin=None, rightMargin=None, topMargin=None, bottomMargin=None, showBoundary=None, allowSplitting=None, title=None, author=None, **kwargs):
        return self.child('template', pagesize=pagesize, rotation=rotation, leftMargin=leftMargin, rightMargin=rightMargin, topMargin=topMargin, bottomMargin=bottomMargin, showBoundary=showBoundary, allowSplitting=allowSplitting, title=title, author=author, **kwargs)
    ...
    def frame(self, x1=None, y1=None, width=None, height=None, id=None, leftPadding=None, rightPadding=None, topPadding=None, bottomPadding=None, showBoundary=None, **kwargs):
        return self.child('frame', x1=x1, y1=y1, width=width, height=height, id=id, leftPadding=leftPadding, rightPadding=rightPadding, topPadding=topPadding, bottomPadding=bottomPadding, showBoundary=showBoundary, **kwargs)
    ...
    def keepInFrame(self, maxWidth=None, maxHeight=None, mergeSpace=None, onOverflow=None, id=None, frame=None, **kwargs):
        return self.child('keepInFrame', maxWidth=maxWidth, maxHeight=maxHeight, mergeSpace=mergeSpace, onOverflow=onOverflow, id=id, frame=frame, **kwargs)

    def keepTogether(self, maxHeight=None, **kwargs):
        return self.child('keepTogether', maxHeight=maxHeight, **kwargs)

    def imageAndFlowables(self, imageName=None, imageWidth=None, imageHeight=None, imageMask=None, imageLeftPadding=None, imageRightPadding=None, imageTopPadding=None, imageBottomPadding=None, imageSide=None, **kwargs):
        return self.child('imageAndFlowables', imageName=imageName, imageWidth=imageWidth, imageHeight=imageHeight, imageMask=imageMask, imageLeftPadding=imageLeftPadding, imageRightPadding=imageRightPadding, imageTopPadding=imageTopPadding, imageBottomPadding=imageBottomPadding, imageSide=imageSide, **kwargs)
    ...
    def link(self, destination=None, url=None, boxStrokeWidth=None, boxStrokeDashArray=None, boxStrokeColor=None, **kwargs):
        return self.child('link', destination=destination, url=url, boxStrokeWidth=boxStrokeWidth, boxStrokeDashArray=boxStrokeDashArray, boxStrokeColor=boxStrokeColor, **kwargs)

    def hr(self, width=None, thickness=None, color=None, lineCap=None, spaceBefore=None, spaceAfter=None, align=None, valign=None, dash=None, **kwargs):
        return self.child('hr', width=width, thickness=thickness, color=color, lineCap=lineCap, spaceBefore=spaceBefore, spaceAfter=spaceAfter, align=align, valign=valign, dash=dash, **kwargs)
    ...
    def lines(self, linelist=None, strokeWidth=None, strokeColor=None, strokeDashArray=None, symbol=None, **kwargs):
        return self.child('lines', linelist=linelist, strokeWidth=strokeWidth, strokeColor=strokeColor, strokeDashArray=strokeDashArray, symbol=symbol, **kwargs)

    def curves(self, curvelist=None, **kwargs):
        return self.child('curves', curvelist=curvelist, **kwargs)

    def image(self, file=None, x=None, y=None, width=None, height=None, showBoundary=None, preserveAspectRatio=None, **kwargs):
        return self.child('image', file=file, x=x, y=y, width=width, height=height, showBoundary=showBoundary, preserveAspectRatio=preserveAspectRatio, **kwargs)
    ...
    def barCode(self, code=None, value=None, width=None, height=None, strokeColor=None, strokeWidth=None, fillColor=None, barStrokeColor=None, barStrokeWidth=None, barFillColor=None, gap=None, barWidth=None, barHeight=None, ratio=None, checksum=None, bearers=None, quiet=None, lquiet=None, rquiet=None, fontName=None, fontSize=None, humanReadable=None, stop=None, spaceWidth=None, shortHeight=None, textColor=None, x=None, y=None, **kwargs):
        return self.child('barCode', code=code, value=value, width=width, height=height, strokeColor=strokeColor, strokeWidth=strokeWidth, fillColor=fillColor, barStrokeColor=barStrokeColor, barStrokeWidth=barStrokeWidth, barFillColor=barFillColor, gap=gap, barWidth=barWidth, barHeight=barHeight, ratio=ratio, checksum=checksum, bearers=bearers, quiet=quiet, lquiet=lquiet, rquiet=rquiet, fontName=fontName, fontSize=fontSize, humanReadable=humanReadable, stop=stop, spaceWidth=spaceWidth, shortHeight=shortHeight, textColor=textColor, x=x, y=y, **kwargs)

    def textField(self, title=None, x=None, y=None, width=None, height=None, value=None, maxLength=None, multiline=None, **kwargs):
        return self.child('textField', title=title, x=x, y=y, width=width, height=height, value=value, maxLength=maxLength, multiline=multiline, **kwargs)
    ...
    def barChart(self, dx=None, dy=None, dwidth=None, dheight=None, angle=None, x=None, y=None, width=None, height=None, strokeColor=None, strokeWidth=None, fillColor=None, debug=None, direction=None, useAbsolute=None, barWidth=None, groupSpacing=None, barSpacing=None, **kwargs):
        return self.child('barChart', dx=dx, dy=dy, dwidth=dwidth, dheight=dheight, angle=angle, x=x, y=y, width=width, height=height, strokeColor=strokeColor, strokeWidth=strokeWidth, fillColor=fillColor, debug=debug, direction=direction, useAbsolute=useAbsolute, barWidth=barWidth, groupSpacing=groupSpacing, barSpacing=barSpacing, **kwargs)
    ...
    def text(self, x=None, y=None, angle=None, text=None, fontName=None, fontSize=None, fillColor=None, textAnchor=None, **kwargs):
        return self.child('text', x=x, y=y, angle=angle, text=text, fontName=fontName, fontSize=fontSize, fillColor=fillColor, textAnchor=textAnchor, **kwargs)

    def barChart3D(self, dx=None, dy=None, dwidth=None, dheight=None, angle=None, x=None, y=None, width=None, height=None, strokeColor=None, strokeWidth=None, fillColor=None, debug=None, direction=None, useAbsolute=None, barWidth=None, groupSpacing=None, barSpacing=None, thetaX=None, thetaY=None, zDepth=None, zSpace=None, **kwargs):
        return self.child('barChart3D', dx=dx, dy=dy, dwidth=dwidth, dheight=dheight, angle=angle, x=x, y=y, width=width, height=height, strokeColor=strokeColor, strokeWidth=strokeWidth, fillColor=fillColor, debug=debug, direction=direction, useAbsolute=useAbsolute, barWidth=barWidth, groupSpacing=groupSpacing, barSpacing=barSpacing, thetaX=thetaX, thetaY=thetaY, zDepth=zDepth, zSpace=zSpace, **kwargs)

    def linePlot(self, dx=None, dy=None, dwidth=None, dheight=None, angle=None, x=None, y=None, width=None, height=None, strokeColor=None, strokeWidth=None, fillColor=None, debug=None, reversePlotOrder=None, lineLabelNudge=None, lineLabelFormat=None, joinedLines=None, **kwargs):
        return self.child('linePlot', dx=dx, dy=dy, dwidth=dwidth, dheight=dheight, angle=angle, x=x, y=y, width=width, height=height, strokeColor=strokeColor, strokeWidth=strokeWidth, fillColor=fillColor, debug=debug, reversePlotOrder=reversePlotOrder, lineLabelNudge=lineLabelNudge, lineLabelFormat=lineLabelFormat, joinedLines=joinedLines, **kwargs)

    def line(self, strokeWidth=None, strokeColor=None, strokeDashArray=None, symbol=None, name=None, **kwargs):
        return self.child('line', strokeWidth=strokeWidth, strokeColor=strokeColor, strokeDashArray=strokeDashArray, symbol=symbol, name=name, **kwargs)

    def xValueAxis(self, visible=None, visibleAxis=None, visibleTicks=None, visibleLabels=None, visibleGrid=None, strokeWidth=None, strokeColor=None, strokeDashArray=None, gridStrokeWidth=None, gridStrokeColor=None, gridStrokeDashArray=None, gridStart=None, gridEnd=None, style=None, forceZero=None, minimumTickSpacing=None, maximumTicks=None, labelTextFormat=None, labelTextPostFormat=None, labelTextScale=None, valueMin=None, valueMax=None, valueStep=None, valueSteps=None, rangeRound=None, zrangePref=None, tickUp=None, tickDown=None, joinAxis=None, joinAxisMode=None, joinAxisPos=None, **kwargs):
    ...
    def yValueAxis(self, visible=None, visibleAxis=None, visibleTicks=None, visibleLabels=None, visibleGrid=None, strokeWidth=None, strokeColor=None, strokeDashArray=None, gridStrokeWidth=None, gridStrokeColor=None, gridStrokeDashArray=None, gridStart=None, gridEnd=None, style=None, forceZero=None, minimumTickSpacing=None, maximumTicks=None, labelTextFormat=None, labelTextPostFormat=None, labelTextScale=None, valueMin=None, valueMax=None, valueStep=None, valueSteps=None, rangeRound=None, zrangePref=None, tickLeft=None, tickRight=None, joinAxis=None, joinAxisMode=None, joinAxisPos=None, **kwargs):
    ...
    def pieChart(self, dx=None, dy=None, dwidth=None, dheight=None, angle=None, x=None, y=None, width=None, height=None, strokeColor=None, strokeWidth=None, fillColor=None, debug=None, startAngle=None, direction=None, checkLabelOverlap=None, pointerLabelMode=None, sameRadii=None, orderMode=None, xradius=None, yradius=None, **kwargs):
        return self.child('pieChart', dx=dx, dy=dy, dwidth=dwidth, dheight=dheight, angle=angle, x=x, y=y, width=width, height=height, strokeColor=strokeColor, strokeWidth=strokeWidth, fillColor=fillColor, debug=debug, startAngle=startAngle, direction=direction, checkLabelOverlap=checkLabelOverlap, pointerLabelMode=pointerLabelMode, sameRadii=sameRadii, orderMode=orderMode, xradius=xradius, yradius=yradius, **kwargs)

    def slices(self, strokeWidth=None, fillColor=None, strokeColor=None, strokeDashArray=None, popout=None, fontName=None, fontSize=None, labelRadius=None, fillColorShaded=None, **kwargs):
        return self.child('slices', strokeWidth=strokeWidth, fillColor=fillColor, strokeColor=strokeColor, strokeDashArray=strokeDashArray, popout=popout, fontName=fontName, fontSize=fontSize, labelRadius=labelRadius, fillColorShaded=fillColorShaded, **kwargs)

    def slice(self, strokeWidth=None, fillColor=None, strokeColor=None, strokeDashArray=None, popout=None, fontName=None, fontSize=None, labelRadius=None, swatchMarker=None, fillColorShaded=None, **kwargs):
        return self.child('slice', strokeWidth=strokeWidth, fillColor=fillColor, strokeColor=strokeColor, strokeDashArray=strokeDashArray, popout=popout, fontName=fontName, fontSize=fontSize, labelRadius=labelRadius, swatchMarker=swatchMarker, fillColorShaded=fillColorShaded, **kwargs)

    def pointer(self, strokeColor=None, strokeWidth=None, elbowLength=None, edgePad=None, piePad=None, **kwargs):
        return self.child('pointer', strokeColor=strokeColor, strokeWidth=strokeWidth, elbowLength=elbowLength, edgePad=edgePad, piePad=piePad, **kwargs)

    def pieChart3D(self, dx=None, dy=None, dwidth=None, dheight=None, angle=None, x=None, y=None, width=None, height=None, strokeColor=None, strokeWidth=None, fillColor=None, debug=None, startAngle=None, direction=None, checkLabelOverlap=None, pointerLabelMode=None, sameRadii=None, orderMode=None, xradius=None, yradius=None, perspective=None, depth_3d=None, angle_3d=None, **kwargs):
    ...
    def spiderChart(self, dx=None, dy=None, dwidth=None, dheight=None, angle=None, x=None, y=None, width=None, height=None, strokeColor=None, strokeWidth=None, fillColor=None, debug=None, startAngle=None, direction=None, **kwargs):
        return self.child('spiderChart', dx=dx, dy=dy, dwidth=dwidth, dheight=dheight, angle=angle, x=x, y=y, width=width, height=height, strokeColor=strokeColor, strokeWidth=strokeWidth, fillColor=fillColor, debug=debug, startAngle=startAngle, direction=direction, **kwargs)

    def strands(self, strokeWidth=None, fillColor=None, strokeColor=None, strokeDashArray=None, symbol=None, symbolSize=None, name=None, **kwargs):
        return self.child('strands', strokeWidth=strokeWidth, fillColor=fillColor, strokeColor=strokeColor, strokeDashArray=strokeDashArray, symbol=symbol, symbolSize=symbolSize, name=name, **kwargs)

    def strand(self, strokeWidth=None, fillColor=None, strokeColor=None, strokeDashArray=None, symbol=None, symbolSize=None, name=None, **kwargs):
        return self.child('strand', strokeWidth=strokeWidth, fillColor=fillColor, strokeColor=strokeColor, strokeDashArray=strokeDashArray, symbol=symbol, symbolSize=symbolSize, name=name, **kwargs)

    def strandLabels(self, dx=None, dy=None, angle=None, boxAnchor=None, boxStrokeColor=None, boxStrokeWidth=None, boxFillColor=None, boxTarget=None, fillColor=None, strokeColor=None, strokeWidth=None, frontName=None, frontSize=None, leading=None, width=None, maxWidth=None, height=None, textAnchor=None, visible=None, leftPadding=None, rightPadding=None, topPadding=None, bottomPadding=None, _text=None, row=None, col=None, format=None, **kwargs):
        return self.child('strandLabels', dx=dx, dy=dy, angle=angle, boxAnchor=boxAnchor, boxStrokeColor=boxStrokeColor, boxStrokeWidth=boxStrokeWidth, boxFillColor=boxFillColor, boxTarget=boxTarget, fillColor=fillColor, strokeColor=strokeColor, strokeWidth=strokeWidth, frontName=frontName, frontSize=frontSize, leading=leading, width=width, maxWidth=maxWidth, height=height, textAnchor=textAnchor, visible=visible, leftPadding=leftPadding, rightPadding=rightPadding, topPadding=topPadding, bottomPadding=bottomPadding, _text=_text, row=row, col=col, format=format, **kwargs)

    def spokes(self, strokeWidth=None, fillColor=None, strokeColor=None, strokeDashArray=None, labelRadius=None, visible=None, **kwargs):
        return self.child('spokes', strokeWidth=strokeWidth, fillColor=fillColor, strokeColor=strokeColor, strokeDashArray=strokeDashArray, labelRadius=labelRadius, visible=visible, **kwargs)

    def spoke(self, strokeWidth=None, fillColor=None, strokeColor=None, strokeDashArray=None, labelRadius=None, visible=None, **kwargs):
        return self.child('spoke', strokeWidth=strokeWidth, fillColor=fillColor, strokeColor=strokeColor, strokeDashArray=strokeDashArray, labelRadius=labelRadius, visible=visible, **kwargs)

    def spokeLabels(self, dx=None, dy=None, angle=None, boxAnchor=None, boxStrokeColor=None, boxStrokeWidth=None, boxFillColor=None, boxTarget=None, fillColor=None, strokeColor=None, strokeWidth=None, frontName=None, frontSize=None, leading=None, width=None, maxWidth=None, height=None, textAnchor=None, visible=None, leftPadding=None, rightPadding=None, topPadding=None, bottomPadding=None, **kwargs):
        return self.child('spokeLabels', dx=dx, dy=dy, angle=angle, boxAnchor=boxAnchor, boxStrokeColor=boxStrokeColor, boxStrokeWidth=boxStrokeWidth, boxFillColor=boxFillColor, boxTarget=boxTarget, fillColor=fillColor, strokeColor=strokeColor, strokeWidth=strokeWidth, frontName=frontName, frontSize=frontSize, leading=leading, width=width, maxWidth=maxWidth, height=height, textAnchor=textAnchor, visible=visible, leftPadding=leftPadding, rightPadding=rightPadding, topPadding=topPadding, bottomPadding=bottomPadding, **kwargs)
