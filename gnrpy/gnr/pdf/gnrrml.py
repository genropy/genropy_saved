...
if __name__ =='__main__':
    ...
    ta.content(content='X::PDF PX(S) MT(PINK)')
    ...
    para1.content(content='Hello World.  This is a normal paragraph. Blah')
    para1.font(color="red").content(content='IPO') 
    para1.content(content="""blah blah blah blah growth forecast blah
