...
# ##### BEGIN: PROXY DEFINITION ########
    ...
    def rpc_gridConfigurationMenu(self,gridId=None,table=None,selectedViewPkey=None):
        ...
        result.setItem('baseview',None,
                        action="genro.dev.loadGridBaseView(this.attr.gridId)",
        ...
        result.setItem('delete',None,label='!!Delete',action='genro.dev.deleteGridView(this.attr.gridId);',gridId=gridId,disabled='==_selectedViewPkey==null;',_selectedViewPkey='=.selectedViewPkey')
        return result
