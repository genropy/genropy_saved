...
#
    ...
    def formbuilder(self, cols=1, table=None, tblclass='formbuilder',
        ...
        if kwargs.get('fbname'):
            kwargs['fbname'] = kwargs['fbname'] if not table else '%s:%s' %(table,kwargs['fbname'])
...
class GnrDomSrc_dojo_11(GnrDomSrc):
    ...
    gnrNS = ['DbSelect','CallBackSelect','RemoteSelect', 'DbComboBox', 'DbView', 'DbForm', 'DbQuery', 'DbField',
             ...
             'DocItem','UserObjectLayout', 'PalettePane','PaletteMap','PaletteImporter','DropUploader','VideoPickerPalette','GeoCoderField','StaticMap','ImgUploader','TooltipPane','MenuDiv', 'BagNodeEditor',
