...
class GnrDomSrc_dojo_11(GnrDomSrc):
    ...
    gnrNS = ['DbSelect', 'DbComboBox', 'DbView', 'DbForm', 'DbQuery', 'DbField',
             ...
             'tinyMCE', 'protovis','MultiButton','PaletteGroup', 'PalettePane','PaletteMap','GeoCoderField','StaticMap','ImgUploader','TooltipPane','MenuDiv', 'BagNodeEditor',
    ...
    def includedview_draganddrop(self,dropCodes=None,**kwargs):
        ...
        if dropCodes:
            for dropCode in dropCodes.split(','):
                ...
                print 'ATTRIBUTI DI DROP',dropmode,dropCode,ivattr[dropmode]
