...
gnrlogger = gnrlogging.getLogger('gnr.xtnd.sync4Dtransaction')
        ...
        if not request_id: # import
            ...
            if len(prevTransactions) == 0: # normal case: is a new transaction
                ...
                if prevTransactions[0]['error_id']:
                    ...
                    gnrlogger.warning("Replacing old wrong transaction %s with new from file %s" % (request_id, file_name))
                else:
