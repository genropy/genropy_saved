...
setup(
        ...
        scripts=['../scripts/gnrdbsetup','../scripts/gnrmkinstance','../scripts/gnrmksite','../scripts/gnrmkpackage','../scripts/gnrwsgiserve',
                '../scripts/gnrsendmail','../scripts/gnrsitelocalize','../scripts/gnrtrdeamon','../scripts/rmltester','../scripts/gnrsync4d',
                '../scripts/wk2pdf','../scripts/gnrmkproject','../scripts/gnrdbstruct','../scripts/gnrdbgraph','../scripts/gnr'],
        ...
        data_files=data_files,
        install_requires = ['paste','beaker','mako','webob','weberror','vobject','pytz','babel','python-memcached','pypdf','argparse'],
        zip_safe=False,
        extras_require = dict(
            #pdf = ['z3c.rml'],
            postgres = ['psycopg2'],
