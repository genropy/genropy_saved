...
setup(
        ...
        scripts=['../scripts/gnrdbsetup', '../scripts/gnrmkinstance', '../scripts/gnrmkthresource','../scripts/gnrmksite','../scripts/gnrxml2py', '../scripts/gnrheartbeat', '../scripts/gnrmkpackage',
                 ...
                 '../scripts/gnrwsgi', '../scripts/gnruwsgi', '../scripts/gnrasync','../scripts/gnrlocalizer', '../scripts/gnrvassal', '../scripts/gnrsite','../scripts/gnrupdate','../scripts/gnrsite','../scripts/gnrdeploybuilder'],
