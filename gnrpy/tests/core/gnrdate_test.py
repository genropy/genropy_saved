...
def test_quarter():
    ...
    res = gnrdate.decodeDatePeriod(u'1º trimestre', workdate=workdate, locale='it')
    assert res == '2008-01-01;2008-03-31'

    res = gnrdate.decodeDatePeriod(u"dal 1º trimestre al 2º trimestre", workdate=workdate, locale='it')
    assert res == '2008-01-01;2008-06-30'
