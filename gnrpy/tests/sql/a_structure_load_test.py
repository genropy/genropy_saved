...
class TestDbModelSrc(object):
    ...
    def test_externalPackage(self):
        assert self.db_fromxml.packageSrc('video').table('movie').externalPackage('video') == self.db_fromxml.packageSrc('video')
    ...
    def test_column(self):
        assert self.db_fromcode.packageSrc('video').table('movie').column('description').attributes['name_short'] == 'Dsc'
    ...
    def test_relation(self):
        assert self.db_fromxml.packageSrc('video').table('cast').column('person_id')['relation?related_column']=="people.id"
