...
class GnrCustomWebPage(object):
    ...
    def remote_campiTipoImpianto(self, pane, tipoImpianto=None, disabled=None, **kwargs):
        self.formCampiTipo(pane, tipo=tipoImpianto, table='cond.im_tipo', disabled=disabled, **kwargs)
