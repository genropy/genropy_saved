...
class GnrCustomWebPage(object):
    ...
    def formBase(self,parentBC,disabled=False,**kwargs):
        ...
        fb.field('adm.user.username',width='15em',lbl='!!Username')
        fb.field('adm.user.firstname',width='15em',lbl='!!Firstname')
        fb.field('adm.user.lastname',width='15em',lbl='!!Lastname')
