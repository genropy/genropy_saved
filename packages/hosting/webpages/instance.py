...
class GnrCustomWebPage(object):
    ...
    def formBase(self,parentBC,disabled=False,**kwargs):
        ...
        instancecp.dataRpc('.$creation_result', 'createInst', instance_name='=.name', instance_exists='=.$instance_exists', site_exists='=.$site_exists', _fired='^.$create',_onResult='FIRE .$created')
        instancecp.dataController("""
                ...
                """,site_path='=.$creation_result.site_path', instance_path='=.$creation_result.instance_path', _fired='^.$created')
    def orderBase(self):
        return 'username'
    ...
    def rpc_createInst(self,instance_name=None, instance_exists=None, site_exists=None):
        ...
        if not instance_exists:
            result['instance_path']=instancetbl.create_instance(instance_name, self.site.instance_path, self.site.gnrapp.config)
        if not site_exists:
