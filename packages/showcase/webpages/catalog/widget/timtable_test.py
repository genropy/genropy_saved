            ...
            if random.random() > .4:
                ...
                while timeslot + deltaminutes <= timecurr + deltavisits:
                    ...
                    if z < .25:
                        ...
                        slot['patient'] = ['Morelli', 'Bappini', 'Panzarotti', 'Baboden', 'Capatonda', 'Fufolo'][
                                          int(random.random() * 5)]
                    else:
                        slot['patient'] = '-'
                    slots.append(slot)
            ...
            for x in range(36):
                ...
                if random.random() > .5:
                    ...
                    app = inner.div(background=color, position='absolute', top='%ipx' % cy, left='%ipx' % cx,
                                    ...
                                    _class='rounded_max shadow_2',
                                    connect_onclick='genro.dom.setClass(this.domNode,"zoommed","toggle")')
