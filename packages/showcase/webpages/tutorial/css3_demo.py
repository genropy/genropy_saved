...
class GnrCustomWebPage(object):
    ...
    def sizingMaker(self, pane, lbl, datapath):
        ...
        fb.horizontalslider(lbl='!!Round Corners', value='^.round', width='100px', minimum=0, maximum=100,
    ...
    def gradientMaker(self, pane, lbl, datapath):
        ...
        fb.horizontalslider(lbl='!!Colorstop', value='^.colorstop', width='100px', minimum=0, maximum=1,
                            intermediateChanges=True)


    def borderMaker(self, pane, lbl, datapath):
        fb = pane.formbuilder(cols=3, datapath=datapath, lbl=lbl, lblpos='T')
        fb.horizontalslider(lbl='!!Width', value='^.width', width='100px', minimum=0, maximum=30,
                            intermediateChanges=True)
