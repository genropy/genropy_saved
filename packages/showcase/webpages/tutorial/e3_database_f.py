...
class GnrCustomWebPage(object):
    def main(self, root, **kwargs):
        ...
        self.boxPartecipanti(right_bottom)
    ...
    def dataModel(self, pane):
        ...
        pane.dataRecord('ordine.record', 'assopy.ordine', '^ordine.id')
    ...
    def boxOrdini(self, pane):
        ...
        r = struct.view().rows(classes='tablewiew_grid', cellClasses='tablewiew_cells',
                               headerClasses='tablewiew_headers')
        r.fieldcell('numero')
    ...
    def boxPartecipanti(self, pane):
        struct = self.newGridStruct('assopy.ordine_riga')
        r = struct.view().rows(classes='tablewiew_grid', cellClasses='tablewiew_cells',
                               headerClasses='tablewiew_headers')
        r.fieldcell('@partecipante.cognome', width='10em')
        r.fieldcell('@partecipante.nome', width='10em')
        r.fieldcell('@partecipante.py_level')
        r.fieldcell('@partecipante.qualifica_badge', width='10em')
        r.fieldcell('@partecipante.presenza', width='10em')

        pane.includedView(storepath='ordine.record.@assopy_ordine_riga_ordine_id',
                          struct=struct)