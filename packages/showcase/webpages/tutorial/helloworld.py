...
class GnrCustomWebPage(object):
    ...
    def main(self, root, **kwargs):
        ...
        mainbc=rootbc.borderContainer(region='center',border='3px solid red', margin='10px',background_color='white')
        mainbc.contentPane(region='top',height='30px',splitter=True,background_color='pink').div('io sono il top')
        mainbc.contentPane(region='bottom',height='30px',splitter=True,background_color='yellow').div('io sono il bottom')
        mainbc.contentPane(region='right',width='100px',splitter=True,background_color='orange').div('io sono destra')
    ...
    def centerPane(self,pane):
        ...
        for k in range(100):
            quadro.div('%i'%k,height='10px',width='10px',font_size='7px',border='1px solid red',margin='3px',float='left')
