...
class GnrCustomWebPage(object):
    ...
    def main(self,root,**kwargs):
        ...
        center.dataRpc('dummy','sendMail', to_address='=mail.to', from_address='=mail.from',async='=mail.async', subject='=mail.subject', body='=mail.body', _fired='^mail.send')
    ...
    def rpc_sendMail(self, to_address=None, from_address=None, subject=None, body=None, async=False):
        ...
        self.site.mail_handler.sendmail(to_address, subject, body,from_address=from_address,
                            host='smtp.gmail.com',tls=True, user='michele.bertoldi@gmail.com', password='rotring', html=True, async=async)
        print time.time()-t
