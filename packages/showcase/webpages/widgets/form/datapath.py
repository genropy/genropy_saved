...
class GnrCustomWebPage(object):
    ...
    beginning of son's datapath, like:
        box = pane.div(datapath='father')   (same as before)
        box.textbox(value='^.son')          (same as before)
    ...
    Pay attention to not create a relative path without an absolute father-path!"""
    ...
    def test_1_basic(self,pane):
        """Standard datapath"""
        #   - test_1:
        #       Simple example of datapath. In the first line "datapath='father'" is
        ...
        #       Try to type something in textbox and retrieve it in Datasource.
    ...
    def test_2_abs_rel(self,pane):
        ...
        #   - test_2:
        #       In this test you can see how datapath can build a relative path or an absolute
        #       path (use datasource).
        ...
        #   - test_3:
        #       To see a datapath example inserted in a formbuilder, see test_3 in formbuilder.py
