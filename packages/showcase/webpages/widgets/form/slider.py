...
class GnrCustomWebPage(object):
    ...
    """ Here we introduce the sliders. It is a scale with a handle you can drag left/right for
    horizontal slider (or up/down for vertical one) to select a value.
    They are form widgets inherit from Dojo.
    
    - slider's attributes (and default values)
        ...
        intermediateChanges     (Boolean) If True, changes value of slider DURING the mouse move (False)
        
    It is strongly advised to use:
        - "width" attribute for horizontal slider.
        - "height" attribute for vertical slider. """
