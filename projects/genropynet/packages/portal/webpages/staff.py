...
class GnrCustomWebPage(object):
    ...
    def formBase(self, parentBC, disabled=False, **kwargs):
        ...
        bc.dataController("""var roles = roles.split(',');
                          ...
                          _fired='^.id', _if='roles')
        self.staffForm(bc.contentPane(region='top', _class='pbl_roundedGroup', height='40%', margin='5px'),
                       disabled=disabled)
    ...
    def onSaving(self, recordCluster, recordClusterAttr, resultAttr):
        ...
        if userRecord['md5pwd']:
            ...
            userRecord.setItem('md5pwd',
                               self.application.changePassword(False, False, userRecord.pop('md5pwd'), userid))
