...
class Table(object):
    def config_db(self, pkg):
        ...
        tbl.column('id', size='22', group='_', readOnly=True, unique=True, name_long='!![it]Id')
        ...
        tbl.column('comune_id' ,size='22',name_long='!![it]Comune').relation('glbl.comune.id', mode='foreignkey',relation_name='localita')
