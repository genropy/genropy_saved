...
class Table(object):
    def config_db(self, pkg):
        ...
        tbl.column('regione', size='3', name_long='!!Regione',validate_notnull=True).relation('glbl.regione.sigla',
                                                                        ...
                                                                        eager_one=True)
        tbl.column('nome', size=':128', name_long='!!Nome', indexed=True,validate_notnull=True)
        tbl.column('nome_locale', size=':128'   , name_long='!!Nome Locale', indexed=True)
        ...
        tbl.column('nuts', size=':128' ,name_long='!!NUTS3').relation('glbl.nuts.code',relation_name='province',onDelete='raise')
