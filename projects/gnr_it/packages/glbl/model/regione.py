...
class Table(object):
    def config_db(self, pkg):
        ...
        tbl.column('nome', size=':128', name_long='!!Nome', indexed=True)
        ...
        tbl.column('nuts', size=':128', name_long='!!NUTS2').relation('glbl.nuts.code',relation_name='regioni',onDelete='raise')
