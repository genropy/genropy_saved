...
class Table(object):
    def config_db(self, pkg):
        ...
        tbl.column('sigla', size='3', group='_', readOnly=True, name_long='!!Sigla')
        tbl.column('nome',size=':50', name_long='!!Nome', indexed=True)
        tbl.column('nome_locale',size=':50', name_long='!!Nome Locale', indexed=True)
        ...
        tbl.column('nuts',size=':50',name_long='!!NUTS2').relation('glbl.nuts.code',relation_name='regioni',onDelete='raise')
