var loginManager = {
    notificationManager:function(notification_id,onNotificationCb){
        ...
        box._('div',{innerHTML:notification_data.notification,border:'1px solid silver'});
        var bar = dlg.bottom._('slotBar',{slots:'cancel,*,confirm_checkbox,2,confirm'});
...
dojo.declare("gnr.FramedIndexManager", null, {
    ...
    reloadSelectedIframe:function(rootPageName,modifiers){
        ...
        if(iframe){
            ...
            iframe.sourceNode._genro.pageReload({debug_sql:dodebug,pageReloading:true});
        }
    },
