...
class GnrCustomWebPage(object):
    ...
    def main(self, root, userid=None, **kwargs):
        ...
        sc, top, bottom = self.pbl_rootStackContainer(root, '!!New user', selected='^_pbl.selectedPage', width='450px',
                                                      height='230px', centered=True)
    ...
    def savingPane(self, sc, bottom):
        ...
        center.div(template=u"!!Thank you for registering ^.firstname ^.lastname", datasource='^form.data.user',
                   margin_top='2em',
    ...
    def pageExpired(self, sc, bottom):
        ...
        bottom['right'].div('!!Registration page', connect_onclick="genro.pageReload({userid:''})", float='right',
                            _class='bottom_btn')
