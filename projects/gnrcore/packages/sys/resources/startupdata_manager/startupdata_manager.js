var startupdata_manager = {
    startupPackageChecked:function(tree,dataNode){
        var current_data = tree.sourceNode.getRelativeData('.db_template_source') || new gnr.GnrBag();
        ...
        if(is_checking_true){
            if(current_data.getNode(package)){
                ...
                current_data.setItem(package,null,{package:package,filepath:dataNode.attr.abs_path});
            }
        }else{
