...
a specially formatted string. \"code1:value1,code2:value2\"

When a menu item is selected the code is placed as the data at the path specified by the value parameter.
