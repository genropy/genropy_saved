...
class GnrCustomWebPage(object):
    ...
    #showTabs=True
    authTags='user'
    login_title = '!!Imdb login' # here the title
    ...
    def windowTitle(self):
        return '!!Imdb Database'

    def windowTitleTemplate(self):
       return 'IMDB Database' # ?? what is the difference between windowTitle


    def loginSubititlePane(self,pane):#here you can define the sub title as you required a 
        pane.div('Please log in User:imdb Password:imdb',text_align='center',font_size='.9em',font_style='italic',color='#AAAAAA')
