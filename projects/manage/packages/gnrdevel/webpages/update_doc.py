...
class GnrCustomWebPage(object):
    ...
    def main(self, rootBC, **kwargs):
        ...
        buttons.div(_class='button_placeholder', float='left').button('!!Update documentation', fire="update_doc", visible="==(!_busy)", _busy="^busy")
        buttons.div("^busy")
        center.data('busy','')
        
        center.contentPane(region="center", style="overflow: scroll").pre("^results_log")
        
        center.dataRpc('results_log','updateDocumentation',_fired="^update_doc", _onCalling="SET busy = 'Updating documentation... Please wait.'", _onResult="SET busy = ''")
