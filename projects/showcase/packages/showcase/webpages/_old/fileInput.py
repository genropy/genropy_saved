...
class GnrCustomWebPage(object):
    ...
    def test_1_basic(self, pane):
        ...
        pane.div("""We show you the "genro.dlg.upload": its first parameter is the name
                    of the dialogue window (you can see this window by clicking the button
                    "Upload"; in this example the name is "Upload something"), the second
                    parameter is the name of the Rpc method you're calling, the third
                    parameter is the folder for the data uploaded.""",
