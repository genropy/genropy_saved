...
class GnrCustomWebPage(object):
    def main(self, root, **kwargs):
        ...
        top = lc.layoutContainer(layoutAlign='top', height='15ex',
                                 border_bottom='2px solid grey').div('top')
        top_left = top.contentPane(layoutAlign='left', width='22em',
                                   padding='20px', border_right='2px solid grey').div('top_left')
        top_right = top.contentPane(layoutAlign='client', padding='20px').div('top_right')
