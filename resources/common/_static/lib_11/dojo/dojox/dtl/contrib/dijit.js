...
return new _2.AttachNode(dojo.trim(_31).slice(16).split(/\s*,\s*/));
},dojoAttachEvent:function(_32,_33){
return new _2.EventNode(_33.slice(16));
},dojoType:function(_34,_35){
if(_2.widgetsInTemplate){
var _36=_34.swallowNode();
var _37=false;
if(_35.slice(-7)==" parsed"){
_37=true;
_36.setAttribute("dojoType",dojo.trim(_35).slice(0,-7));
}
