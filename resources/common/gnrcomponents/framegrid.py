...
class FrameGridSlots(BaseComponent):
    ...
    @struct_method
    def fgr_slotbar_addrow(self,pane,_class='icnBaseAdd',enable=None,parentForm=True,**kwargs):
        return pane.slotButton(label='!!Add',publish='addrow',baseClass='no_background',iconClass=_class,visible=enable,parentForm=parentForm,**kwargs)
