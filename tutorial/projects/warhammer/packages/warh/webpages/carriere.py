...
######################## STANDARD TABLE OVERRIDDEN METHODS ################ 
    ...
    def lstBase(self,struct):
        ...
        r.fieldcell('ac',width='4em')
        r.fieldcell('ab',width='4em')
        r.fieldcell('forza',width='4em')
        r.fieldcell('resistenza',width='4em')
